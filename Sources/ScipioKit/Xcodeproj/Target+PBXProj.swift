...
extension ResolvedTarget {
    ...
    var productType: String {
        ...
        case .systemModule, .binary, .plugin, .macro:
            fatalError("[productType] unsupported target type")
        }
    }
    ...
    var explicitFileType: String {
        ...
        case .systemModule, .binary, .plugin, .macro:
            fatalError("[explicitFileType] unsupported target type")
        }
    }
    ...
    var productPath: RelativePath {
        ...
        case .systemModule, .plugin, .macro:
            fatalError("[productPath] unsupported target type")
        }
    }
    ...
    var productName: String {
        ...
        case .test, .executable, .snippet:
            return "'$(TARGET_NAME)'"
        case .systemModule, .binary, .plugin, .macro:
            fatalError("[productName] unsupported target type")
        }
    }
}
